...
*Based on [Emma Fontanella's recipe](https://www.emmafontanella.com/easy-no-knead-ciabatta-bread)*
...
- **Prep time:** 20 minutes (active), plus 4 × 30-minute rest intervals
- **Rise time:** Overnight cold ferment + 20 minutes final proof
...
- Large bowl (square if possible, e.g. 9×9 inch)
- Fine mesh strainer (for dusting flour evenly)
- Bench/dough scraper
- 2 clean dish towels
- Pizza stone or large baking tray
- Parchment paper
- Handful of ice cubes (for steam)
...
- The overnight fermentation is essential. It builds flavor and makes the dough much easier to handle.
- Sift your flour. The dough is extremely wet, any gaps in the flour and it will stick.
- Handle gently throughout shaping (not stretch-and-fold.) Every bubble counts. Rough handling in the final shaping stages deflates the open crumb you're working toward.
- Judge by color, not time. Every oven is different. Deep golden brown is your cue, not the clock.
- Flour type matters. A strong bread flour (~13% protein) gives the best results. All-purpose will work but produces a denser crumb.
